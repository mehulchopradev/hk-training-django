...
class LibappBook(models.Model):
    title = models.CharField(max_length=50)
    price = models.FloatField(blank=True, null=True)
    pages = models.IntegerField()
    no_of_copies = models.IntegerField()
    publication = models.ForeignKey('LibappPublicationhouse', models.DO_NOTHING)
...
class LibappPublicationhouse(models.Model):
...
class LibappReview(models.Model):
    reviewer = models.CharField(max_length=20)
    description = models.CharField(max_length=100)
    book = models.ForeignKey(LibappBook, models.DO_NOTHING)
